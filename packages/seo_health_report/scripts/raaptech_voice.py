...
def generate_executive_summary_raaptech(
    ...
    if market_position and competitors_count:
        hook = "Your competitors are showing up in AI search results. You're not.\n\n"
    else:
    ...
    if revenue_impact:
        ...
        problem = (
            "Your website has critical SEO issues that are costing you business. "
            "Every day these issues persist, potential customers find your competitors instead.\n\n"
        )

    # INSIGHT: What they don't realize
    if score < 50:
        insight = (
            "Here's what's happening: AI systems can't parse your website. "
            "No schema markup. No structured data. No way for AI to understand "
            "what you do, where you are, or why you're qualified. "
            "Result: You're invisible in 35% of searches.\n\n"
        )
    elif score < 70:
        insight = (
            "Most fabricators think SEO is about Google rankings. But 35% of "
            "searches now happen in AI systems. Your Google ranking doesn't "
            "matter if AI systems don't know you exist.\n\n"
        )
    else:
        insight = (
            "You're doing better than most. But there's still money on the table. "
            "Small improvements in AI visibility and technical SEO translate "
            "directly to more qualified leads.\n\n"
        )
    ...
    if score < 50:
        outcome = (
            "In 90 days, you could be the shop that shows up in AI search. "
            "Bids come to you. Your phone rings. You're not chasing work—work finds you.\n\n"
        )
    elif score < 70:
        outcome = (
            "In 90 days, you could be ranking above your competitors. "
            "More qualified leads. Better conversion. Less time chasing bids.\n\n"
        )
    else:
        outcome = (
            "In 90 days, you could be the dominant player in your market. "
            "First choice for contractors. Premium pricing. Work comes to you.\n\n"
        )
