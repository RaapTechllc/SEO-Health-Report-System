...
try:
    from seo_health_report.scripts.cache import TTL_AI_RESPONSE, cached
...
# =============================================================================
# FAST models: High-volume presence checks (cheap, low latency)
# QUALITY models: SEO analysis, recommendations, summaries (higher quality)
#
# For presence checks (query_all_systems), use FAST models by default.
# For analysis/reports, explicitly pass model=QUALITY variant.

# Anthropic Claude - Primary SEO Analysis
ANTHROPIC_MODEL_FAST = os.environ.get("ANTHROPIC_MODEL_FAST", "claude-4-haiku-20251120")
ANTHROPIC_MODEL_QUALITY = os.environ.get("ANTHROPIC_MODEL_QUALITY", "claude-sonnet-4-5-20250929")
ANTHROPIC_MODEL = os.environ.get("ANTHROPIC_MODEL", ANTHROPIC_MODEL_FAST)

# OpenAI - Summaries & Synthesis
OPENAI_MODEL_FAST = os.environ.get("OPENAI_MODEL_FAST", "gpt-5-nano")
OPENAI_MODEL_QUALITY = os.environ.get("OPENAI_MODEL_QUALITY", "gpt-5")
OPENAI_MODEL = os.environ.get("OPENAI_MODEL", OPENAI_MODEL_FAST)

# Google Gemini - Large Context & Image Generation
GEMINI_MODEL_FAST = os.environ.get("GOOGLE_MODEL_FAST", "gemini-3.0-flash")
GEMINI_MODEL_QUALITY = os.environ.get("GOOGLE_MODEL_QUALITY", "gemini-3.0-pro")
GEMINI_MODEL = os.environ.get("GOOGLE_MODEL", GEMINI_MODEL_FAST)

# Perplexity - Search-Augmented AI (citations matter)
PERPLEXITY_MODEL_FAST = os.environ.get("PERPLEXITY_MODEL_FAST", "sonar")
PERPLEXITY_MODEL_QUALITY = os.environ.get("PERPLEXITY_MODEL_QUALITY", "sonar-pro")
PERPLEXITY_MODEL = os.environ.get("PERPLEXITY_MODEL", PERPLEXITY_MODEL_FAST)

# xAI Grok - Real-time Reputation & X/Twitter Discourse
GROK_MODEL_FAST = os.environ.get("XAI_MODEL_FAST", "grok-4-1-fast")
GROK_MODEL_QUALITY = os.environ.get("XAI_MODEL_QUALITY", "grok-4-1")
GROK_MODEL = os.environ.get("XAI_MODEL", GROK_MODEL_FAST)
...
async def query_xai(
    ...
    try:
        ...
        data = {
            "model": os.environ.get("XAI_MODEL", GROK_MODEL),
            "messages": [{"role": "user", "content": query}],
            "max_tokens": 1024,
        }
...
async def query_perplexity(
    ...
    try:
        ...
        data = {
            "model": os.environ.get("PERPLEXITY_MODEL", PERPLEXITY_MODEL),
            "messages": [{"role": "user", "content": query}],
            "max_tokens": 1024,
        }
...
async def query_gemini(
    ...
    try:
        ...
        model = os.environ.get("GOOGLE_MODEL", GEMINI_MODEL)
