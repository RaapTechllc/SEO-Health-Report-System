...
class GapAnalyzer:
    ...
    def analyze_competitive_gaps(
        self, prospect_report: dict[str, Any], competitor_reports: dict[str, dict[str, Any]]
    ) -> list[TalkingPoint]:
    ...
    def _analyze_ai_visibility_gaps(
    ...
    def _analyze_technical_gaps(
        ...
        competitor_tech_scores = [
            report.get("technical", {}).get("score", 0) for report in competitor_reports.values()
        ]
        ...
        if prospect_tech < avg_competitor_tech:
            ...
            points.append(
                TalkingPoint(
                    ...
                    supporting_data="Areas likely affected: page speed, crawlability, mobile optimization",
                    confidence=0.8,
                )
            )
    ...
    def _analyze_content_gaps(
        ...
        competitor_content_scores = [
            report.get("content", {}).get("score", 0) for report in competitor_reports.values()
        ]
    ...
    def _analyze_overall_gaps(
        ...
        competitor_scores = [
            report.get("overall_score", 0) for report in competitor_reports.values()
        ]
