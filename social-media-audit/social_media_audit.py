...
def run_social_audit(company_name: str, domain: str) -> Dict[str, Any]:
    ...
    overall_score = int(
        (linkedin_result['score'] * 0.3) +  # LinkedIn is most important for B2B
        (profiles_result['score'] * 0.5) +  # Having profiles matters
        (consistency_result['score'] * 0.2)  # Consistency is nice-to-have
    )
    ...
    return {
        ...
        "findings": [
            ...
            *profiles_result['findings'][:3],  # Top 3 findings
        ],
