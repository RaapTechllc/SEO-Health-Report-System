...
- [ ] Feature flags configured (if risky)
- [ ] Rollback plan exists (if applicable)

## End-of-Session

After execution completes, run:
1. `@execution-report` - Document what was built
2. `@system-review` - Identify process improvements
3. `@memory` - Capture learnings for next session