...
1. Run `@system-review` to analyze process improvements
2. Run `@memory` to capture learnings and update documentation

## Memory Handshake

This report provides input for `@memory`. Key items to capture:

- **What shipped**: [from Completed Tasks]
- **Decisions made**: [from Divergences - why we changed approach]
- **Patterns discovered**: [from What Went Well]
- **Risks introduced**: [from Challenges + Divergences]
- **Follow-ups**: [from Skipped Items + Recommendations]