...
import sys
import os
sys.path.append(os.path.join(os.path.dirname(__file__), '..', 'competitive-monitor'))
...
from competitive_intel.battlecards import battlecard_generator
from multi_tier_reports.tier_classifier import tier_classifier
from multi_tier_reports.pricing_optimizer import pricing_optimizer
