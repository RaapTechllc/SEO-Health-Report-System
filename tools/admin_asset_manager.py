...
def main():
    ...
    banner_parser.add_argument(
        "--industry", required=True, help="Industry name (e.g., 'Construction')"
    )
    banner_parser.add_argument(
        "--style", default="Professional, modern, clean", help="Visual style prompt"
    )
    banner_parser.add_argument(
        "--model", default="imagen-4.0-ultra-generate-001", help="AI Model to use"
    )
