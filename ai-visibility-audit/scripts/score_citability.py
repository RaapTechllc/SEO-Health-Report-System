...
def analyze_content_citability(url: str) -> Dict[str, Any]:
    ...
    if citable_content:
        ...
        # Categorize by type
        content_types = set(c.content_type for c in citable_content)
...
def analyze_site_citability(
    ...
    if page_results:
        ...
        diversity_bonus = min(3, len(set(c.content_type for c in all_citable)))
    ...
    return {
        ...
        "content_type_distribution": {
            ...
            for ct in set(c.content_type for c in all_citable)
        }
    }
